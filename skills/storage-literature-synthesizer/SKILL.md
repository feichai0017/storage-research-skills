...
6. Compress the result into reusable constraints, comparison axes, and related-work framing.
...
- paper cluster note for a concrete topic
...
- `references/hotspot-reading.md` for turning recent accepted papers and CFPs into a scoped reading plan
